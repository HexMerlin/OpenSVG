...
public record Coordinate(double Long, double Lat)
{
    ...
    /// </summary>
    /// <param name="dxMeters">The east-west translation (movement) in meters. Positive values means to the east, negative values means to the west. </param>
    /// <param name="dyMeters">The north-south translation (movement) in meters. Positive values means to the north, negative values means to the south. </param>
