...
public abstract class SvgVisualContainer : SvgVisual, ISvgElementContainer
{
    ...
    /// <summary>
    /// Adds an <see cref="SvgVisual"/> child inside this <see cref="SvgVisualContainer"/> with specified horizontal and vertical alignment.
    /// </summary>
    /// <remarks>Alignment is calculated relative to the bounding boxes of parent and child, when the add is made.
    ...
    public override (bool Equal, string Message) CompareSelfAndDescendants(SvgElement other, double doublePrecision = Constants.DoublePrecision)
    {
        ...
        SvgVisualContainer sameType = (SvgVisualContainer)other;
