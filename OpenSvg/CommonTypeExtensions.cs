...
public static class CommonTypeExtensions
{
    ...
    public static bool RobustEquals(this double number1, double number2, double precision = Constants.DoublePrecision) 
        => Math.Abs(number1 - number2) < precision;

    public static bool RobustEquals(this float number1, float number2, double precision = Constants.DoublePrecision)
        => Math.Abs(number1 - number2) < precision;
