...
{
    private enum SkipGrahamScan { Yes }
    ...
    /// </summary>
    /// <remarks>
    /// This specialized private constructor is intended for internal optimization purposes. It bypasses the Graham's scan algorithm.
    ...
    /// <remarks>The algorithm is based on selecting a pivot point, sorting the 
    ...
    private static IEnumerable<Point> ExtractHullPoints(Point[] points)
    {
        ...
        Array.Sort(points, (a, b) => Math.Atan2(a.Y - pivot.Y, a.X - pivot.X).CompareTo(Math.Atan2(b.Y - pivot.Y, b.X - pivot.X)));
