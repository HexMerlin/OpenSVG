...
public static class TestPaths
{
    ...
    public static (string ExpectedFilePath, string ActualFilePath) GetReferenceAndActualTestFilePaths(string testName, string fileSuffix) =>
        (
    ...
    public static string GetTestFilePath(string testName, string fileSuffix, FileCategory fileCategory)
        => Path.Combine(GetTestDirectory(fileCategory), $"{testName}_{fileCategory}.{fileSuffix}");
